...
export const Hero: React.FC<HeroProps> = ({ onCTAClick }) => {
  ...
  const slides = [
      ...
      rightContent: (
        <div className="relative z-10 p-4">
          ...
          <div className="w-full h-[500px] relative">
            <div className="absolute inset-8 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-500 rounded-full blur-2xl opacity-25"></div>
            <div className="absolute inset-12 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 rounded-full blur-xl opacity-15"></div>
    ...
    // Slide 2: About Platform
    {
      ...
      rightContent: (
        <div className="relative z-10 p-4">
          <div className="w-full h-[500px] relative">
            <div className="absolute inset-8 bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 rounded-full blur-2xl opacity-25"></div>
            <div className="absolute inset-12 bg-gradient-to-r from-purple-500 via-blue-500 to-indigo-600 rounded-full blur-xl opacity-15"></div>
            <div className="relative w-full h-full flex items-center justify-center">
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 max-w-full py-12 md:py-24">
